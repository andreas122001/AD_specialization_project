This repository contains code from a master's thesis project which builds on the <a href="https://github.com/autonomousvision/carla_garage">carla_garage</a> repository, which repository this repository is a fork of, and the TransFuser++ autonomous driving model.
